//
//  SudokuBoardExtension.swift
//  Sudoku_IN_Swift
//
//  Created by Andrew Peal on 24/7/2022.
//
...
class extendBoard : sudokuBoard {
    ...
    override func fillBoard() {
        ...
        for pos in boxOrder {
            ...
            let sortedOne = amounts.sorted { (first, second) ->  Bool in
                return first.value > second.value
            }

            print("_amounts is: \(sortedOne)");
